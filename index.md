...
- How does MQ for z/OS perform when moving to z17? Paper [MQ for z/OS on z17](./MQ_for_zOS_on_z17.pdf) discusses the performance expectations and what we achieved when moving from IBM z16 to IBM z17. The paper also discusses the changes from CFCC level 26 and the the new Network Express adapter.
