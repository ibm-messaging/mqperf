...
#### Telemetry (MQTT)
- IBM MQ V9.4.5 Telemetry (MQTT V3) Performance Report : [MQ V9.4.5 Telemetry Report](./MQ_9.4.5_Telemetry_Report_v1.0.pdf)
...
- MQ for z/OS 9.4 performance report [MQ for zOS 10.0 Performance.pdf](./MQ%20for%20zOS%2010.0%20Performance.pdf). This report discusses the performance characteristics of the MQ for z/OS 10.0 release including the performance of new features Long CONNAME and Open Telemetry support alongside the increase to maximum log output buffer size. Initial release in September 2026.
...
- How does MQ for z/OS perform when moving to z17? Paper [MQ for z/OS on z17](./MQ_for_zOS_on_z17.pdf) discusses the performance expectations and what we achieved when moving from IBM z16 to IBM z17. The paper also discusses the changes from CFCC level 26 and the new Network Express adapter.
- How does MQ for z/OS perform when moving to z16? Paper [MQ for z/OS on z16](./MQ_for_zOS_on_z16.pdf) discusses the performance expectations and what we achieved when moving from IBM z15 to IBM z16. The paper also discusses the changes from CFCC level 25 and the new Crypto Express 8S feature.
