...
- IBM MQ V9.1 for Linux (x86-64 platform) Performance Report: [MQ_for_xLinux_V910_Performance.pdf](./MQ_V9.1_Performance_Report_xLinux.pdf)
...
- MQ for z/OS Capacity Planning and Tuning guide [MP16.pdf](./mp16.pdf). This report provides capacity planning and setup/tuning information for IBM MQ for z/OS version 9.2 and earlier releases. It describes how to define performance critical queue manager and channel initiator environment parameters. This version of the report includes a refresh of measurements for IBM z15, plus updates relating to MQ version 9.2, specifically for data set encryption, zHyperWrite support for active logs and TLS 1.3 support on MQ channels.
